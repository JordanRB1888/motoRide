...
function applicationForm(email='+58driver@example.com',phone='+584120009999',overrides={}){const form=new FormData();Object.entries({firstName:'María',lastName:'Conductora',identityNumber:'V-24.680.135',birthDate:'1994-05-20',phone,email,password:'ClaveSegura123',address:'Avenida principal, Maracaibo',city:'Maracaibo',region:'Zulia',vehicleType:'MOTO',vehicleBrand:'Bera',vehicleModel:'BR200',vehicleYear:'2024',vehicleColor:'Amarillo',vehiclePlate:'APP58X',servicesAppliedFor:'PASSENGER_TRANSPORT',rif:'V-24680135-7',licenseGrade:'2',licenseExpiration:'2028-01-01',...overrides}).forEach(([key,value])=>form.append(key,value));requiredDocs.forEach(type=>form.append(type,new Blob([png],{type:'image/png'}),`${type}.png`));return form;}
