...
export async function renderAdminSupport(container) {
  ...
  const bindEvents = () => {
    ...
    container.querySelector('#broadcast')?.addEventListener('click', () => window.dispatchEvent(new CustomEvent('58express:admin-tab', { detail: 'communications' })));
  };
