    ...
    <div class="diorama-card-3d" style="padding: 18px 16px; border-radius: 24px; background: var(--surface-card); border: 1.5px solid var(--border-gold);">
      ...
      <div style="display:flex; align-items:center; justify-content:space-between; gap: 12px; margin-bottom: 16px; background: var(--surface-elevated); padding: 12px 16px; border-radius: 16px; border: 1px solid var(--border-color);">
        ...
        <button class="btn-cancel-route-icon" title="Cambiar Destino" style="
          ...
          padding: 6px 10px; border-radius: 12px; font-size: 0.8rem; font-weight: 800; cursor: pointer; flex-shrink:0;
        ">
          ✕ Cancelar
        </button>
      </div>
      ...
      <div style="display:flex; justify-content:space-between; align-items:center; background: rgba(255, 193, 7, 0.06); padding: 16px; border-radius: 20px; border: 1px solid rgba(255,193,7,0.25); margin-bottom: 16px;">
        ...
        <div style="text-align: right;">
          <div style="background: var(--surface-card); padding: 6px 12px; border-radius: 12px; border: 1px solid var(--border-color); margin-bottom: 6px;">
            ...
            <div style="font-weight: 800; color: var(--text-primary); font-size: 0.95rem;">📍 ${fareData.distance}</div>
          </div>
          <div style="background: var(--surface-card); padding: 6px 12px; border-radius: 12px; border: 1px solid var(--border-color);">
            ...
            <div style="font-weight: 800; color: var(--accent-secondary); font-size: 0.95rem;">⏱️ ${fareData.duration}</div>
          </div>
        </div>
      </div>
      ...
      ">
        <div style="display:flex; align-items:center; gap: 12px;">
          <div style="width: 38px; height: 38px; border-radius: 10px; background: rgba(0,210,255,0.15); color: var(--accent-secondary); display: flex; align-items: center; justify-content: center; font-size: 1.1rem;">
            💳
          </div>
          <div>
      ...
      <button class="btn btn-3d primary-btn confirm-ride-btn" style="
        ...
        border-radius: 18px; letter-spacing: 0.5px; margin-bottom: 10px;
      ">
        ⚡ SOLICITAR +58EXPRESS AHORA
      </button>
      ...
      ">
        📅 Programar / Reservar para Más Tarde
      </button>
      ...
      ">
        ✕ Cancelar Ruta y Elegir Otro Destino
      </button>
    </div>
  `;
  ...
  div.innerHTML = `
    <div class="diorama-card-3d" style="padding: 30px 20px; border-radius: 24px; background: var(--surface-card); border: 1.5px solid var(--border-gold);">
      <div class="ripple-container" style="position:relative; width: 120px; height: 120px; margin: 0 auto 20px; display:flex; align-items:center; justify-content:center;">
        ...
        <div style="font-size: 3rem; position:relative; z-index:2; animation: bounce 1s infinite alternate;">🏍️</div>
      </div>
      
      <h3 style="color: var(--text-primary); font-size: 1.3rem; font-weight: 800; margin-bottom: 6px;">Buscando moto en Maracaibo...</h3>
      <p style="color: var(--text-secondary); font-size: 0.9rem; margin-bottom: 24px;">Conectando con mototaxistas cercanos verificado 🇻🇪</p>
      ...
      <button class="btn btn-danger btn-outline cancel-btn" style="
        ...
        display:flex; align-items:center; justify-content:center; gap:8px;
      ">
        ✕ Cancelar Solicitud y Cambiar Ruta
      </button>
    </div>
  `;
    ...
    <div class="diorama-card-3d" style="padding: 20px; border-radius: 24px; background: var(--surface-card); border: 2px solid var(--accent-secondary);">
      <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom: 16px;">
        <div style="display:flex; align-items:center; gap: 12px;">
          ...
          <div>
            ...
            <div style="color: var(--accent-primary); font-size: 0.85rem; font-weight: 700; margin-top: 2px;">
              ⭐ ${driver.rating || 4.9} (${driver.totalTrips || 120} viajes)
            </div>
          </div>
        </div>
        <div style="background: rgba(0,230,118,0.15); border: 1px solid var(--success); color: var(--success); padding: 8px 14px; border-radius: 16px; font-weight: 800; font-size: 0.85rem;">
          ⏱️ En Camino
        </div>
      </div>
      ...
      <div style="display:flex; justify-content:space-between; align-items:center; background: var(--surface-elevated); padding: 12px 16px; border-radius: 16px; border: 1px solid var(--border-color); margin-bottom: 16px;">
        <div>
          ...
          <strong style="color:var(--text-primary); font-size:0.95rem;">🏍️ ${driver.vehicleBrand || 'Bera'} ${driver.vehicleModel || 'SBR'} (${driver.vehicleColor || 'Negro'})</strong>
        </div>
      ...
      ">
        ✕ Cancelar Orden y Elegir Otra Ruta
      </button>
    </div>
  `;
