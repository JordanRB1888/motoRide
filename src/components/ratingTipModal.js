  ...
  const render = () => {
    modal.innerHTML = `
      ...
      <div class="passenger-rating-driver">
        <img src="${driver?.photoUrl || `https://api.dicebear.com/7.x/avataaars/svg?seed=${encodeURIComponent(driver?.firstName || 'Carlos')}`}" alt="Conductor ${driver?.firstName || 'Carlos'}">
